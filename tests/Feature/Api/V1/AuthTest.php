...
describe('Registration with Phone', function (): void {
    it('registers with a valid Palestinian phone number', function (): void {
        $response = $this->postJson('/api/v1/register', [
            'name' => 'Phone User',
        ...
        $response->assertStatus(201)
            ->assertJsonPath('data.user.phone', '+970591234567');
    ...
    it('registers without phone number', function (): void {
        $response = $this->postJson('/api/v1/register', [
            'name' => 'No Phone User',
    ...
    it('fails with invalid phone format', function (): void {
        $response = $this->postJson('/api/v1/register', [
            'name' => 'Bad Phone',
